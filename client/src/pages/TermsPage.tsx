    ...
    <div className="min-h-screen bg-[#080b0f] text-[#e6edf3] font-sans flex flex-col">
      ...
      <main className="flex-1 mx-auto w-full max-w-5xl px-4 py-8 font-mono text-xs space-y-6">
        ...
        <div className="border-b border-[#1e2631] pb-4">
          <div className="flex items-center gap-2 text-[#58a6ff] text-[11px] font-bold uppercase tracking-wider mb-1">
            <Scale size={13} />
          ...
          <div className="flex flex-wrap items-center gap-4 text-[11px] text-[#8b9bb0] mt-2">
            ...
            <span>•</span>
            <span className="text-[#3fb950]">OPEN-SOURCE MIT LICENSE</span>
          </div>
        </div>

        {/* ─── Critical Authorization Warning Banner ──────────────────── */}
        <div className="bg-[#0c1015] border-l-2 border-[#d29922] p-4 text-xs text-[#e6edf3] space-y-1">
          <div className="flex items-center gap-2 font-bold text-[#d29922]">
            <AlertTriangle size={14} className="shrink-0" />
            <span>MANDATORY AUTHORIZED SCANNING REQUIREMENT</span>
          </div>
          <p className="font-sans text-[11px] text-[#8b9bb0] leading-relaxed">
        ...
        <section className="space-y-3">
          ...
          <div className="bg-[#10151b] border border-[#1e2631] p-4 text-xs font-sans text-[#8b9bb0] space-y-2 leading-relaxed">
            <p>Users agree to comply with all applicable local, national, and international laws. You agree NOT to:</p>
            <ul className="list-disc list-inside space-y-1.5 font-mono text-[11px] text-[#e6edf3]">
        ...
        <section className="space-y-3">
          ...
          <div className="space-y-2 text-xs font-sans text-[#8b9bb0] leading-relaxed">
            ...
            <div className="bg-[#0c1015] border border-[#1e2631] p-3 space-y-2 font-mono text-[11px]">
              <div>
                <strong className="text-[#58a6ff]">Absence of Evidence is Not Proof of Absence:</strong>
              ...
              <div className="border-t border-[#171f28] pt-2">
                <strong className="text-[#58a6ff]">Third-Party Dependency Limitations:</strong>
                <p className="font-sans text-[#8b9bb0] mt-0.5">
                  CT log indexes (<code className="text-[#e6edf3]">crt.sh</code>), WHOIS registries, and GeoIP routing databases are operated by external third parties. They may be temporarily rate-limited, delayed, or incomplete.
                </p>
              </div>
              <div className="border-t border-[#171f28] pt-2">
                <strong className="text-[#58a6ff]">Datacenter Geolocation Disclaimer:</strong>
                <p className="font-sans text-[#8b9bb0] mt-0.5">
        ...
        <section className="space-y-3">
          ...
          <div className="bg-[#10151b] border border-[#1e2631] p-3.5 space-y-2 text-xs font-sans text-[#8b9bb0] leading-relaxed">
            <p className="font-mono text-[11px] text-[#e6edf3] uppercase">
        ...
        <section className="space-y-3">
          ...
          <div className="bg-[#0c1015] border border-[#1e2631] p-3 text-xs font-sans text-[#8b9bb0] leading-relaxed">
            <p>
